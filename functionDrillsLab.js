...
console.log(compareNums(5, 10)); // 10
console.log(compareNums(10, 5)); // 10
console.log(compareNums(5, 5)); // 5
...
console.log(nameGreeting); // What is up Steven?
...
console.log(colorRating); // green is a solid favorite color
...
console.log(oddChecker); // That is odd indeed!
...
console.log(bestMovie(`Sharknado`)); // Sharknado is the best movie ever!
...
function buyChocolateFrogs(gold) {
  const costPerFrog = 3;
  let totalFrogs = Math.floor(gold / costPerFrog);
  return totalFrogs;
}
...
console.log(arrayIsAscending); // false
